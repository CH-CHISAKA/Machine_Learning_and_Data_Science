...
![measures-of-variability](<measures-of-variability.png>)

There are different formulas for population and sample variance and standard deviation.
- This is due to the fact that sample formulas are the unbiased estimators of the population formulas


![variance-formula](<variance-formula.png>)


As the sample size increase, the sampling distribution of the sample mean becomes narrower because the sample mean varies less from sample to sample.

For small sample sizes, the distribution may retain more of the skewness of the exponential population. As the sample size increase, the distribution of the sample means becomes more concentrated around the population mean and tends towards a more symmetric shape.

Increasing the sample size improve the stability of the sample mean.
